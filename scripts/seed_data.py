...
# --- SUPABASE CONFIG ---
SUPABASE_URL = "https://kafjzhrzfvbqzkguzprq.supabase.co"
SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImthZmp6aHJ6ZnZicXprZ3V6cHJxIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc4MTg2NzYzOSwiZXhwIjoyMDk3NDQzNjM5fQ.eXu5VeouGbT7PM8YbfrOYG-qjVKmQTjwTuoy87ERWpQ"
# Note: The assignment says Service Role Key is needed for seeding usually, 
# but the user provided the anon key. Seeding might fail if the anon key doesn't have 
# permission to upload to storage/insert. 
